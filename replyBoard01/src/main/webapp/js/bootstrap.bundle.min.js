        ...
        ? (function (t, e, i) {
            return function n(s) {
              ...
              for (let { target: r } = s; r && r !== this; r = r.parentNode)
                for (const a of o) if (a === r) return M(s, { delegateTarget: r }), n.oneOff && P.off(t, s.type, e, i), i.apply(r, [s]);
            };
          })(t, i, r)
        : (function (t, e) {
            return function i(n) {
  ...
  const ce = {
    ...
    fn: function (t) {
      ...
      if (o && r) {
        var h = (function (t, e) {
            return ae(
              "number" != typeof (t = "function" == typeof t ? t(Object.assign({}, e.rects, { placement: e.placement })) : t) ? t : le(t, vt)
            );
          })(s.padding, i),
          d = Gt(o),
          u = "y" === l ? pt : _t,
  ...
  function ue(t) {
    ...
    if (c) {
      ...
      A === $t(i) && "static" !== Zt((A = ee(i))).position && "absolute" === a && ((E = "scrollHeight"), (T = "scrollWidth")),
        (s === pt || ((s === _t || s === gt) && o === wt)) &&
          ((y = mt), (m -= (d && A === w && w.visualViewport ? w.visualViewport.height : A[E]) - n.height), (m *= l ? 1 : -1)),
        (s !== _t && ((s !== pt && s !== mt) || o !== wt)) ||
          ((v = gt), (f -= (d && A === w && w.visualViewport ? w.visualViewport.width : A[T]) - n.width), (f *= l ? 1 : -1));
    }
    var C,
    ...
    fn: function (t) {
      ...
      null != e.modifiersData.popperOffsets &&
        (e.styles.popper = Object.assign(
          {},
          e.styles.popper,
          ue(Object.assign({}, c, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: r, roundOffsets: l }))
        )),
        null != e.modifiersData.arrow &&
          (e.styles.arrow = Object.assign(
            {},
            e.styles.arrow,
            ue(Object.assign({}, c, { offsets: e.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: l }))
          )),
      ...
      w = (function (t, e, i, n) {
        var s =
          ...
          a = o.reduce(function (e, i) {
            var s = Oe(t, i, n);
            return (
              (e.top = Vt(s.top, e.top)), (e.right = Kt(s.right, e.right)), (e.bottom = Kt(s.bottom, e.bottom)), (e.left = Vt(s.left, e.left)), e
            );
          }, Oe(t, r, n));
        ...
        for (
          var s = i.mainAxis,
            ...
            v = [g].concat(b).reduce(function (t, i) {
              return t.concat(
                qt(i) === bt ? Le(e, { placement: i, boundary: h, rootBoundary: d, padding: c, flipVariations: p, allowedAutoPlacements: m }) : i
              );
            }, []),
            y = e.rects.reference,
            w = e.rects.popper,
        ...
        h = {
          ...
          setOptions: function (i) {
            ...
            d(),
              ...
              (a.scrollParents = { reference: Wt(t) ? Te(t) : t.contextElement ? Te(t.contextElement) : [], popper: Te(e) });
            var r,
              c,
              u = (function (t) {
                var e = He(t);
    ...
    _getPopperConfig() {
      ...
      return (
        (this._inNavbar || "static" === this._config.display) &&
          (H.setDataAttribute(this._menu, "popper", "static"), (t.modifiers = [{ name: "applyStyles", enabled: !1 }])),
    ...
    _getTemplateFactory(t) {
      return (
        this._templateFactory
          ...
          : (this._templateFactory = new Ui({ ...this._config, content: t, extraClass: this._resolvePossibleFunction(this._config.customClass) })),
        this._templateFactory
      );
    }
